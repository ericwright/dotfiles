...
hi def tpProject term=bold,underline cterm=bold,underline gui=bold,underline ctermbg=Gray guifg=#95C7EF
hi def tpDoneTask ctermfg=Gray guifg=Gray
hi def tpContext guifg=#ffffcc
...
HiLink taskpaperContext       tpContext
